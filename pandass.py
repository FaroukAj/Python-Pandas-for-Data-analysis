...
print(" PRINTING THE FIRST ITEMS IN THE GROUP :",df16.last())#PRINTING THE FIRST ITEMS IN THE GROUP
...
print("column 2 : ", col2[0:10]) #PRINTING THE FIRST 10 ITEMS OF OOUR DATAFRAME
...
#USING SORT_VALUES TO SORT A DATAFRAME BY ASCENDING OR DESCENDING ORDER
age_sort = df14.sort_values(by=['Age'], ascending=False)
print('SORTED DATAFRAME' , age_sort)
